...
namespace ResponsiPemrograman2713
{
    class Program
    {
        static void Main(string[] args)
        {
            karyawan pegawai1 = new karyawan(1234567890, "alfandi", 35000000);
            karyawan pegawai2 = new karyawan(0987654321, "zaenidin", 40000000);
